...
const fetchNotes = async (params)=>{
    ...
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["api"].get("/notes", {
        params,
        headers: {
            Cookie: cookieHeader
        }
...
const fetchNoteById = async (id)=>{
    ...
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["api"].get(`/notes/${id}`, {
        headers: {
            Cookie: cookieHeader
        }
    });
