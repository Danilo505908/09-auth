...
async function GET() {
    try {
        ...
        if (refreshToken) {
            ...
            const apiRes = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["api"].get("auth/session", {
                headers: {
                    Cookie: cookieHeader
                }
            });
            ...
            if (setCookie) {
                ...
                for (const cookieStr of cookieArray){
                    ...
                    // Parse attributes
                    const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cookie$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parse"])(cookieStr);
                    const options = {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__15f645d7._.js.map