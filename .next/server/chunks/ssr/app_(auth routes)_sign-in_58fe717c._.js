...
function SignInPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError("");
        try {
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$clientApi$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])({
                email,
                password
            });
            setUser(user);
...
//# sourceMappingURL=app_%28auth%20routes%29_sign-in_58fe717c._.js.map